...
<table width="100%" border="0" cellspacing="0" cellpadding="0"	style="margin-top: 10px;">
	...
	<c:forEach var="purchase" items="${list}">
		<tr class="ct_list_pop">
			<td align="center">
				<a href="/getPurchase.do?tranNo=${purchase.tranNo}">${purchase.rowNum}</a>
			</td>
			<td></td>
			<td align="left">
			...
			<td align="left">
				<c:choose>
					<c:when test="${purchase.tranCode=='2  '}">
					<a href="/updateTranCode.do?prodNo=${purchase.purchaseProd.prodNo}&tranCode=3&page=${resultPage.currentPage}">물건도착</a>
					</c:when>
					<c:otherwise>
					</c:otherwise>
				</c:choose>
